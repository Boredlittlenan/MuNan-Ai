...
- Conversation history loads from Tauri commands and is persisted in backend SQLite, including message image attachment metadata/data; `localStorage` is only used for lightweight UI state and legacy migration.
