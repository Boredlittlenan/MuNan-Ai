...
- Agent 设置与快速动作：设置页新增 Agent 设置，可管理总开关、浏览器操作、系统操作、Shell 执行、Tavily 联网搜索、高风险确认、单次步数和技能白名单；聊天页已支持打开网页、读取网页文本、打开本地路径、复制文本，并可由 AI 根据对话需求自动规划 Shell 命令或 Tavily 搜索。
