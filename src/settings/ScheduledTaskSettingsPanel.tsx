...
export function scheduleFormFromTask(task: AgentScheduledTask): AgentScheduleForm {
  ...
  return {
    ...
    kind: task.kind,
    scheduleMode: task.schedule_mode ?? "once",
    weekdays:
      Array.isArray(task.weekdays) && task.weekdays.length
        ? task.weekdays
